      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-text-secondary text-sm mb-6">
              Trải nghiệm lưu trú theo phong cách điện ảnh. Không gian riêng tư,
              tiện nghi hiện đại, mang đến cho bạn những phút giây thư giãn
              tuyệt vời.
            </p>
            <div className="flex gap-4">
              ...
              <a
                href="#"
                className="text-text-muted hover:text-accent-neon transition-colors"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <form
              ...
              onSubmit={(e) => {
                e.preventDefault();
                success("Cảm ơn bạn đã đăng ký nhận bản tin!");
              }}
            >
              <input
                type="email"
              ...
              <button
                type="submit"
                className="bg-accent-primary text-white font-bold py-2 px-4 rounded-md hover:bg-red-600 transition-all text-sm uppercase"
              >
                Đăng ký
              </button>
            </form>
        ...
        <div className="border-t border-border-subtle mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-text-muted text-sm">
            &copy; {new Date().getFullYear()} GenZ Cinema Homestay. All rights
            reserved.
          </p>
