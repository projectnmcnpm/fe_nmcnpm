    ...
    <DashboardLayout allowedRoles={['manager']}>
      <div className="h-full flex flex-col min-h-0 max-w-4xl mx-auto w-full">
        <div className="shrink-0 flex items-center gap-4 mb-6">
          <Link href="/admin/bookings" className="p-2 bg-bg-secondary rounded hover:bg-border-subtle transition-colors">
            <ArrowLeft size={20} />
          </Link>
          <div>
            <h1 className="text-2xl text-text-primary">THÊM ĐẶT PHÒNG MỚI</h1>
            <p className="text-sm text-text-secondary">Tạo mới thông tin đặt phòng cho khách hàng</p>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-auto pr-2">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="card-cinema p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs text-text-muted font-bold mb-2 uppercase tracking-wider">Chọn phòng *</label>
                ...
                <div>
                  <label className="block text-xs text-text-muted font-bold mb-2 uppercase tracking-wider">Số lượng khách *</label>
                ...
                <div>
                  <label className="block text-xs text-text-muted font-bold mb-2 uppercase tracking-wider">Tổng tiền dự kiến (VNĐ)</label>
                  <input type="number" className="input-field font-mono text-accent-gold" placeholder="0" />
                </div>
                <div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea className="input-field min-h-[80px] resize-y" placeholder="Yêu cầu đặc biệt của khách hàng..."></textarea>
                </div>
              </div>
            </div>
